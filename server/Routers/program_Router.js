...
router.get("/edit_course/:id", program_info.edit_course)
router.post("/add_course/:id", program_info.add_courses)
router.patch("/update_course/:id", program_info.update_course)
router.delete("/delete_course/:id", program_info.delete_course)
